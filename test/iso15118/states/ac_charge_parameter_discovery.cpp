...
SCENARIO("AC charge parameter discovery state handling") {
    GIVEN("Bad Case - Unknown session") {
        ...
        const auto res = d20::state::handle_request(req, d20::Session(), d20::SessionConfig(evse_setup));
    ...
    GIVEN("Bad Case: e.g. ac transfer mod instead of ac_bpt transfer mod - FAILED_WrongChargeParameter") {
        ...
        const auto res = d20::state::handle_request(req, session, d20::SessionConfig(evse_setup));
